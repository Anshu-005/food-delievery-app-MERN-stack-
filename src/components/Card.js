        ...
        <div className="card mt-3 " style={{"width": "18rem", "height":"400px"}}>
          ...
          <div className="card-body">
            ...
            <div className="container w-100">
                <select className='m-2 h-100 bg-danger text-white' onChange={(e)=>setQty(e.target.value)}>
                ...
                <select className='m-2 h-100 bg-danger rounded text-white' ref = {priceRef} onChange={(e)=>setSize(e.target.value)}>
